(() => {
  ...
  const PALETTES = {
    ...
    contrast: ['#0f4fa8','#ed8500','#0a9148','#7b2cbf','#d62828','#0081a7','#e6a300','#4d908e','#577590','#9d4edd','#2a9d8f','#f26419'],
    pastel: ['#8fb8e8','#8fd3c7','#f3c987','#c7afe7','#ef9ea7','#a9c6d9','#cbb18d','#b3d69e','#d8b4d8','#9fc8c2','#d7c4a5','#b8bfdc']
  };
